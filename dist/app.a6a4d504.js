...
exports.default = _default;
        var $0671af = exports.default || module.exports;
      
      if (typeof $0671af === 'function') {
        $0671af = $0671af.options;
      }
    
        /* template */
        Object.assign($0671af, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("button", { staticClass: "b-button" }, [_vm._v("提交")])
}
var staticRenderFns = []
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$0671af', $0671af);
          } else {
            api.reload('$0671af', $0671af);
          }
        }
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "4882" + '/');
