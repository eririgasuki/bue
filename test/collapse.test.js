...
describe('Collapse', () => {
  ...
  it('接受 selected 属性', (done) => {
    ...
    div.innerHTML = `
        <b-collapse :selected="xxx">
          <b-collapse-item title="标题1" name="1"><span id="content-1">1</span></b-collapse-item>
          <b-collapse-item title="标题2" name="2"><span id="content-2">2</span></b-collapse-item>
          <b-collapse-item title="标题3" name="3"><span id="content-3">3</span></b-collapse-item>
        </b-collapse>
    `
    const vm = new Vue({
      el: div,
  ...
  it('接受 single 属性', (done) => {
    ...
    document.body.appendChild(div)
    div.innerHTML = `
        <b-collapse :selected.sync="xxx" single>
          <b-collapse-item title="标题1" name="1"><span id="content-1">1</span></b-collapse-item>
          <b-collapse-item title="标题2" name="2"><span id="content-2">2</span></b-collapse-item>
          <b-collapse-item title="标题3" name="3"><span id="content-3">3</span></b-collapse-item>
        </b-collapse>
  ...
  it('触发 update:selected 事件', (done) => {
    ...
    document.body.appendChild(div)
    div.innerHTML = `
        <b-collapse :selected="xxx" @update:selected="onSelect">
          <b-collapse-item title="标题1" name="1"><span id="content-1">1</span></b-collapse-item>
          <b-collapse-item title="标题2" name="2"><span id="content-2">2</span></b-collapse-item>
          <b-collapse-item title="标题3" name="3"><span id="content-3">3</span></b-collapse-item>
        </b-collapse>
